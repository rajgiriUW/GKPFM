...
class CPD_cluster(object):
    ...
    def __init__(self, h5_file, CPD_group, mask, fast_x=32e-6, slow_y=8e-6):
    
        hdf = px.ioHDF5(h5_file)
        self.h5_main = hdf.file[CPD_group]
        
        self.CPD = self.h5_main['/CPD']
        
        self.FastScanSize = fast_x
        self.SlowScanSize = slow_y
        
        self.mask = mask
        
        self.CPD_1D_vals = self.CPD_positions
